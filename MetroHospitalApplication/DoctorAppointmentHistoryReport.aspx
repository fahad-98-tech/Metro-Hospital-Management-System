<%@ Page Title="Doctor Appointment History" Language="C#" MasterPageFile="~/Doctor.Master" AutoEventWireup="true" CodeBehind="DoctorAppointmentHistoryReport.aspx.cs" Inherits="MetroHospitalApplication.DoctorAppointmentHistoryReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet" />
    <style>
        .status-Booked { background-color: #fff3cd !important; }      
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <h2 class="my-3">Doctor Appointment History</h2>
        ...
        <!-- Summary -->
        <div class="summary">
            Total Appointments: <asp:Label ID="lblTotalAppointments" runat="server" Text="0"></asp:Label>
        </div>
    </div>
</asp:Content>